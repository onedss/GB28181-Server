        ...
        <div id="login-panel" :class="['panel', 'panel-primary', {'visible': showPanel == 'login'}]">
                ...
                <form autocomplete="off" id="login-form">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-4">
                            <button id="btn-annou-login" v-if="serverInfo.DemoUser" type="button" class="btn btn-info btn-block btn-flat" @click.prevent="doAnonLogin" :disabled="isLoading">匿名登录</button>
                        </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right" v-if="serverInfo.APIAuth === false">
