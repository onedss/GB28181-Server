        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <LivePlayer v-if="bShow" :videoUrl="videoUrl" :snapUrl="snapUrl" :live="live" @message="$message" :hideBigPlayButton="!!serverInfo.HideBigPlayButton"
                        :loading.sync="bLoading" v-loading="bLoading" element-loading-text="加载中" element-loading-background="#000"></LivePlayer>
